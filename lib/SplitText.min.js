    ...
    function y(D, u, e, t) {
        ...
        for (
            v.insertBefore(y, D),
                ...
                !1 !== u.reduceWhiteSpace &&
                    (F = F.replace(S, ' ').replace(b, '')),
                l && (F = F.split('<').join('{{LT}}')),
                E = F.length,
                C = (' ' === F.charAt(0) ? A : '') + e(),
                i = 0;
            ...
            if (((r = F.charAt(i)), g && (d = g(F.substr(i), u.specialChars))))
                ...
                '{' === r && '{{LT}}' === F.substr(i, 6)
                    ...
                    : (55296 <= r.charCodeAt(0) && r.charCodeAt(0) <= 56319) ||
                      (65024 <= F.charCodeAt(i + 1) &&
                          F.charCodeAt(i + 1) <= 65039)
                    ? ((n =
                          ((F.substr(i, 12).split(_) || [])[1] || '').length ||
                          2),
                      (C +=
                          h && ' ' !== r
                              ? t() + F.substr(i, n) + '</' + a + '>'
